...
export const fetechProductByFilters = createAsyncThunk("products/fetchByFilters",async({
    collection,
    size,
    color,
    gender,
...
export const fetchProductDetails = createAsyncThunk("products/fetechProductDetails",async(id)=>{
...
const productsSlice = createSlice({
    ...
    extraReducers:(builder)=>{
        builder.addCase(fetechProductByFilters.pending,(state)=>{
            state.loading =true;
            state.error = null;
        })
        .addCase(fetechProductByFilters.fulfilled,(state,action)=>{
            state.loading= false,
            state.products = Array.isArray(action.payload)?action.payload:[];
        })
        .addCase(fetechProductByFilters.rejected,(state,action)=>{
            state.loading =false;
